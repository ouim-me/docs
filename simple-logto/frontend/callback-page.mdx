...
<ParamField path="className" type="string">
  Additional CSS classes to apply to the container element. ```tsx
  <CallbackPage className="bg-gray-50" />
  ```
</ParamField>

<ParamField path="loadingComponent" type="React.ReactNode">
  Custom component to display while processing authentication. ```tsx
  <CallbackPage
    loadingComponent={
...
<ParamField path="successComponent" type="React.ReactNode">
  Custom component to display after successful authentication. ```tsx
  <CallbackPage
    successComponent={
...
<ParamField path="onSuccess" type="() => void">
  Callback function executed after successful authentication, before redirect/close. ```tsx
  <CallbackPage
    onSuccess={() => {
...
<ParamField path="onError" type="(error: Error) => void">
  Callback function executed if authentication fails. ```tsx
  <CallbackPage
    onError={error => {

...
- [verifyAuth](/api/backend/verify-auth) - Generic verification function
- [createExpressAuthMiddleware](/api/backend/create-express-auth-middleware) - Express.js middleware
- [useAuth](/api/hooks/use-auth) - React hook for client-side authentication